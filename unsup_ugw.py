...
def incremental_update_test(ARCH, DATA, pretrained_path="logs/hdc_sub.pth", compare=False):
    ...
    if "sunny" in val_loaders:
        ...
        if compare:
            ...
            model_base = KNNModel(ARCH, MODEL_DIR, 'rp', 0, 0, NUM_CLASSES, device, subcluster_type='continuous')
    ...
    for cond in ADVERSE_CONDITIONS:
        ...
        for cfg in configs_to_run:
            if compare:
                ...
                model = KNNModel(ARCH, MODEL_DIR, 'rp', 0, 0, NUM_CLASSES, device, subcluster_type='continuous')
